...
--
-- Servidor: localhost
-- Tiempo de generación: 27-04-2026 a las 22:29:29
...
--
-- Base de datos: `if0_41712639_centro_medico`
--
...
CREATE TABLE `Cita` (
  ...
  `obcervaciones_cita` text NOT NULL
...
CREATE TABLE `Usuario` (
  ...
  `tipo_usuario` enum('Admnistrador','Asistente','Medico','Paciente') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
(1, 'nicolas@gmail.c', '123', 'Activo', 'Admnistrador');
...
ALTER TABLE `Medico`
  ...
  ADD UNIQUE KEY `medidentificacionMedico` (`identificacion_medico`);
